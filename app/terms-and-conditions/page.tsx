...
export default function TermsAndConditionsPage() {
  return (
    <div className="py-8 bg-slate-50 dark:bg-background">
      <div className="container px-6 md:px-10 lg:w-3/4 mx-auto">
        <div className="mb-6">
          <button
            onClick={() => history.back()}
            className="inline-flex items-center text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300 transition-colors duration-200"
          >
            <ArrowLeft className="h-4 w-4 mr-2" /> Back To App
          </button>
          <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-gray-100 mt-3">
        ...
        <div className="prose prose-sm md:prose dark:prose-invert">
          ...
          <h3>For the purposes of these Terms and Conditions:</h3>
          <ul className="list-disc list-inside">
            <li>
              <strong>Country</strong> refers to: Jakarta, Indonesia
            </li>
            <li>
              <strong>Developer</strong> (referred to as either "the Developer",
              "I", "Me" or "My" in this Agreement) refers to ISB Developer.
            </li>
            <li>
            ...
            <li>
              ...
              between You and the Developer regarding the use of the Service.
            </li>
            <li>
          ...
          <p>
            ...
            and the agreement that operates between You and the Developer. These
          ...
          <p>
            ...
            Developer. Our Privacy Policy describes Our policies and procedures
            on the collection, use and disclosure of Your personal information
            when You use the Application or the Website and tells You about Your
          ...
          <p>
            The Developer has no control over, and assumes no responsibility
            for, the content, privacy policies, or practices of any third party
            web sites or services. You further acknowledge and agree that the
            Developer shall not be responsible or liable, directly or
          ...
          <h2>Termination</h2>
          <p>
            I may terminate or suspend Your access immediately, without prior
          ...
          <p>
            ...
            liability of the Developer and any of its suppliers under any
            provision of this Terms and Your exclusive remedy for all of the
            foregoing shall be limited to the amount actually paid by You
            through the Service or the equivalent of 100 USD in your local
            currency if You haven't purchased anything through the Service.
          </p>
          <p>
            To the maximum extent permitted by applicable law, in no event shall
            the Developer or its suppliers be liable for any special,
            ...
            connection with any provision of this Terms), even if the Developer
          ...
          <p>
            ...
            extent permitted under applicable law, the Developer, on its own
            ...
            foregoing, the Developer provides no warranty or undertaking, and
          ...
          <p>
            Without limiting the foregoing, neither the Developer nor any of the
            developer's provider makes any representation or warranty of any
            ...
            on behalf of the Developer are free of viruses, scripts, trojan
          ...
          <p>
            These Terms and Conditions may have been translated if I have made
          ...
          <p>
            ...
            these Terms at any time. If a revision is material I will make
          ...
          <p>
            ...
            contact me:{" "}
            <Link
              href="mailto:dbgaming679@gmail.com"
              prefetch={false}
